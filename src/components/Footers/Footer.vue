<template>
  <footer class="relative bg-slate-300 pt-8 pb-6">
    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap text-center justify-between lg:items-center lg:text-left">
        <div class="grow px-4">
        ...
        <div class="w-fit mx-auto lg:ml-auto  px-4">
          <router-link to="/chat"
                class="bg-emerald-500 text-white active:bg-emerald-600 text-lg font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                type="button"
              >
               Get Started
            </router-link>
